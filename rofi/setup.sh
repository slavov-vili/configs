...
cp --force --remove-destination --recursive $DIR/widgets $ROFI_DIR
cp --force --remove-destination --recursive $DIR/scripts $ROFI_DIR
cp --force --remove-destination --recursive $DIR/themes  $ROFI_DIR
