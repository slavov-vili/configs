...
source ~/.config/rofi/scripts/rofi_two_column_menu.sh
...
commands[${options[0]}]="sh ~/Scripts/screenshot.sh"
commands[${options[1]}]="sh ~/Scripts/screenshot.sh --selection"
commands[${options[2]}]="sh ~/Scripts/screenshot.sh --window"
commands[${options[3]}]="sh ~/Scripts/screenshot.sh --save"
commands[${options[4]}]="sh ~/Scripts/screenshot.sh --selection --save"
commands[${options[5]}]="sh ~/Scripts/screenshot.sh --window --save"
